...
The **Base Homelab** StackKit deploys a complete, self-hosted infrastructure stack on a single server. It implements the [3-layer architecture](../docs/ARCHITECTURE_V4.md):
...
Base Homelab is the foundation. Extend it with add-ons from `addons/`:
