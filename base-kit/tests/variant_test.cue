...
testDefaultStack: homelab.#BaseKitStack & {
	meta: {
		name:    "test-default"
		version: "3.1.0"
	}
...
testCoolifyStack: homelab.#BaseKitStack & {
	meta: {
		name:    "test-coolify"
		version: "3.1.0"
	}
...
testBeszelStack: homelab.#BaseKitStack & {
	meta: {
		name:    "test-beszel"
		version: "3.1.0"
	}
...
testMinimalStack: homelab.#BaseKitStack & {
	meta: {
		name:    "test-minimal"
		version: "3.1.0"
	}
