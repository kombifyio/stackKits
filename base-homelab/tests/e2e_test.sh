...
echo "==============================================================="
echo "         BASE HOMELAB E2E TESTS - PRODUCTION READY"
echo "==============================================================="
echo ""
...
if $STACKKIT_BIN init base-homelab --non-interactive --force; then
...
if [ $FAILED -eq 0 ]; then
    echo ""
    echo "All E2E tests passed - Base Homelab is PRODUCTION READY"
else
    echo ""
