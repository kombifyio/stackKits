...
# HashiCorp’s New Licensinga new benchmark for presenting license change
...
- They chose their usual [Mozilla Public License, Version 2.0](https://www.mozilla.org/en-US/MPL/2.0/) a [weak-copyleft license](https://blueoakcouncil.org/copyleft#weak-copyleft-family) as the eventual open terms and four years as the timing.
...
- Their [admirable FAQs](https://www.hashicorp.com/license-faq) addresses many kinds of users specifically and repeatedly offers reassurances and custom license terms, requestable by e-mail.
...
| Use Case | Releases |
| --- | --- |
| Old<br> (MPLv2) | New<br> (BSL→MPLv2) |
| --- | --- |
| Non-Production | ✓ | ✓ |
| Production | Competing Products | ✓ | After 4 Years |
| Competing Services | ✓ | After 4 Years |
| Other | ✓ | ✓ |
...
In practice, I don’t expect the fuzziness around “non-production” to matter any more than for “non-commercial”. If your use case is on the line, that’s [probably more your problem than theirs](https://writing.kemitchell.com/2023/07/15/Vague-No-Ops).
...
> If your use of the Licensed Word does not comply with the requirements currently in effect as described in this License, you must purchase a commercial license from the Licensor...or you must refrain from using the Licensed Work.
...
[always welcome by e-mail](mailto:kyle@kemitchell.com).


[back to top](https://writing.kemitchell.com/2023/08/18/HashiCorp-BSL.html#title)
—
[edit on GitHub](https://github.com/kemitchell/writing.kemitchell.com/blob/main/_posts/2023-08-18-HashiCorp-BSL.md)
—
[revision history](https://github.com/kemitchell/writing.kemitchell.com/commits/main/_posts/2023-08-18-HashiCorp-BSL.md)