...
_testValid3NodeHA: #HAHomelabStack & {
	meta: name: "ha-3node"
...
_testValid5NodeHA: #HAHomelabStack & {
	meta: name: "ha-5node"
...
_testValid5ManagerCluster: #HAHomelabStack & {
	meta: name: "ha-5mgr"
...
_testMinimalVariant: #HAHomelabStack & {
...
_testEnterpriseVariant: #HAHomelabStack & {
...
_testNFSBackend: #HAHomelabStack & {
	meta: name: "ha-nfs"
...
_testSimpleModeHA: #HAHomelabStack & {
	meta: name: "ha-simple"
...
_testValid7ManagerCluster: #HAHomelabStack & {
	meta: name: "ha-7mgr"
...
_testVPNCluster: #HAHomelabStack & {
	meta: name: "ha-vpn"
...
//
// _invalidTooFewNodes: #HAHomelabStack & {
//     meta: name: "bad-2node"
//     variant: "default"
//     swarm: managerCount: 3
//     nodes: [
...
//
// _invalidEnterprise3Nodes: #HAHomelabStack & {
...
//
// _invalidEnterpriseLocalStorage: #HAHomelabStack & {
...
//
// _invalidLocalDomain: #HAHomelabStack & {
