// =============================================================================
// Base Homelab Decision Point Tests
// =============================================================================
...
// =============================================================================
// Run individually with: cue vet -d _invalidXxx ./base-homelab/...
...
// Expected error: to must be "ha-homelab" when from == "ha-homelab"
//
...
// Expected error: to must be "modern-homelab" | "ha-homelab" when from == "modern-homelab"
//
// _invalidModernDowngrade: #UpgradePath & {
//     from: "modern-homelab"
//     to:   "base-homelab"      // ← REJECTED: cannot downgrade from modern
// }
...
//     ] // ← REJECTED: base-homelab allows exactly 1 node
//     network: { domain: "test.local"; acmeEmail: "a@b" }
//     services: { traefik: enabled: true; dokploy: enabled: true; dozzle: enabled: true }
// }
